...
public class Simulation {
    ...
    Simulation(Properties properties) {
        ...
        /**
         * modify the robot num to support mode is CYCLING or FLOORING
         * @author Guangxing Lyu and Yujian Wang
         */
        int numRobots;
        if(mode == MailRoom.Mode.CYCLING){
            numRobots = Integer.parseInt(properties.getProperty("robot.number"));
        }else {
            numRobots = numFloors + 2; // flooring always uses building.floors+2 robots
        }
        ...
        /**
         * add the capacity of robot
         * @author Guangxing Lyu and Yujian Wang
         */
        int modeInt = mode == MailRoom.Mode.CYCLING ? 1 : 0;
        mailroom = new MailRoom(building.NUMFLOORS, numRobots, modeInt, robotCapacity);
